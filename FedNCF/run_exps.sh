...
python server.py --config-file configs/lora8_ncf16_freezeB.yaml  --opt TRAIN.device cpu DATALOADER.batch_size 128 TRAIN.lr 0.005
python server.py --config-file configs/lora2_ncf16_freezeB.yaml  --opt TRAIN.device cpu DATALOADER.batch_size 128 TRAIN.lr 0.005