...
# from .sparse import SparseCompress
from .topk import TensorTopK # TopKPerLayer, TopKPerModel
...
from .base import (
    _TensorSubsample, _SubsampleCompressor, _RandomCompressor, _LowRankCompressor)
...
class Compressor:
    ...
    def init_compressor(
        ...
        if issubclass(compressor_name_map[name], _TensorSubsample):
            compressor = compressor_name_map[name](ratio=ratio)
