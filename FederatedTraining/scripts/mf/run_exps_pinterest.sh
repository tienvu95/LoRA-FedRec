...
python fedtrain.py data=pinterest net=fedmf-lora-b net.init.lora_rank=4 net.init.gmf_emb_size=32 task_name=fedtrain TRAIN.wandb=True TRAIN.lr=1e-1 FED.agg_epochs=5000 EVAL.interval=100 DATALOADER.batch_size=256 TRAIN.weight_decay=5e-4 TRAIN.log_interval=10 EXP.project=lora-fedrec-training FED.local_epochs=1
...
python fedtrain.py data=pinterest net=fedmf net.init.gmf_emb_size=32 task_name=fedtrain TRAIN.wandb=True TRAIN.lr=5e-1 FED.agg_epochs=5000 EVAL.interval=100 DATALOADER.batch_size=256 TRAIN.weight_decay=5e-4 compression=svd FED.compression_kwargs.rank=4 EXP.project=lora-fedrec-training FED.local_epochs=1
python fedtrain.py data=pinterest net=fedmf net.init.gmf_emb_size=32 task_name=fedtrain TRAIN.wandb=True TRAIN.lr=5e-1 FED.agg_epochs=5000 EVAL.interval=100 DATALOADER.batch_size=256 TRAIN.weight_decay=5e-4 compression=svd FED.compression_kwargs.rank=8 EXP.project=lora-fedrec-training FED.local_epochs=1
python fedtrain.py data=pinterest net=fedmf net.init.gmf_emb_size=32 task_name=fedtrain TRAIN.wandb=True TRAIN.lr=5e-1 FED.agg_epochs=5000 EVAL.interval=100 DATALOADER.batch_size=256 TRAIN.weight_decay=5e-4 compression=svd FED.compression_kwargs.rank=16 EXP.project=lora-fedrec-training FED.local_epochs=1
python fedtrain.py data=pinterest net=fedmf net.init.gmf_emb_size=32 task_name=fedtrain TRAIN.wandb=True TRAIN.lr=5e-1 FED.agg_epochs=5000 EVAL.interval=100 DATALOADER.batch_size=256 TRAIN.weight_decay=5e-4 compression=svd FED.compression_kwargs.rank=2 EXP.project=lora-fedrec-training FED.local_epochs=1