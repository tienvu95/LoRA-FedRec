...
CUDA_VISIBLE_DEVICES=1 python server.py --config-file configs/amv/ncf16.yaml  --opt TRAIN.device cuda DATALOADER.batch_size 256 TRAIN.lr 0.003 FED.num_clients 50
