...
parser.add_argument('--lora_freeze_B', type=bool, default=False)
...
str = current_time + '-' + 'latent_dim: ' + str(config['latent_dim']) + '-' + 'lr: ' + str(config['lr']) + '-' + \
      ...
      + 'lora: ' + str(config['lora']) + '-' + 'lora_r: ' + str(config['lora_r']) + '-' + 'lora_alpha: ' + \
        str(config['lora_alpha']) + '-' + 'lora_freeze_B: ' + str(config['lora_freeze_B'])
